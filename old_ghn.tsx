            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-background/80 leading-relaxed mb-8">
                  This isn't just about beesΓÇöit's about ensuring sustainable agriculture and food security for millions across Africa and the world. The time to act is now.
                </p>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-primary-foreground/80 max-w-2xl mx-auto">
                Join our community of supporters strengthening pollinator health and food security across Makueni and Kitui Counties todayΓÇöand building a global network for farmers everywhere.
              </p>
            </div>
