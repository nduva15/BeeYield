    ...
    return (
        <div className="container mx-auto p-6 space-y-8 min-h-screen bg-transparent">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Tabs value={timeRange} onValueChange={setTimeRange} className="bg-white/5 p-1 rounded-lg border border-white/10">
                        <TabsList className="bg-transparent border-none">
                            ...
                            <TabsTrigger value="30d" className="data-[state=active]:bg-amber-500 data-[state=active]:text-black">30d</TabsTrigger>
                        </TabsList>
                    </Tabs>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <StatCard title="Hive Weight" value="42.5" unit="kg" icon={Weight} color="text-amber-500" trend="+1.2kg" />
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between text-xs">
                                        ...
                                        <span className="text-amber-500 font-bold">-82 dBm</span>
                                    </div>
                                    <div className="w-full h-1.5 bg-white/5 rounded-full overflow-hidden">
