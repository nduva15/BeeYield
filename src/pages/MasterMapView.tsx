        ...
        <div className="flex flex-col h-[calc(100vh-140px)] animate-in fade-in duration-500">
            ...
            <div className="flex items-center justify-between mb-8 border-b-4 border-[#064e3b] pb-6">
                ...
                <div className="flex gap-4">
                    ...
                    <Button className="rounded-none bg-[#064e3b] text-white font-black uppercase text-[10px] tracking-widest h-12 px-6 shadow-[4px_4px_0px_0px_rgba(16,185,129,1)] hover:translate-y-1 hover:shadow-none transition-all">
            ...
            <div className="flex-1 flex gap-8 min-h-0">
                    ...
                    {[
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                activeTool === tool.id
                                    ? "bg-[#064e3b] border-[#064e3b] text-white shadow-[4px_4px_0px_0px_rgba(16,185,129,1)]"
                    ...
                    <AnimatePresence>
                        {showGeofences && (
                            <motion.div
                                ...
                                exit={{ opacity: 0, x: 20 }}
                                className="absolute top-8 right-8 w-64 p-6 bg-[#064e3b] border-4 border-[#10b981] text-white shadow-[8px_8px_0px_0px_rgba(250,204,21,1)]"
                            >
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="text-[8px] font-bold text-white/40 uppercase leading-snug">
                ...
                <div className="w-96 flex flex-col gap-8">
                    ...
                    <Card className="flex-1 rounded-none border-4 border-[#064e3b] bg-[#064e3b] text-white shadow-[8px_8px_0px_0px_rgba(250,204,21,1)] overflow-hidden">
                        <div className="p-8">
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    <div key={idx} className="flex items-center justify-between p-4 border-2 border-white/10 bg-white/5 hover:bg-white/10 transition-colors cursor-pointer">
