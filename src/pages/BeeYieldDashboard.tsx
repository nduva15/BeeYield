...
import { 
    ...
    Navigation, FileBarChart, Brain, Crosshair, Scale, FileCheck, Bug, Calendar, Heart, Award
} from "lucide-react";
...
const BeeYieldDashboard: React.FC = () => {
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'pollination-planning': return <PollinationPlanning isOpen={true} onClose={() => handleTabChange('home')} embedded={true} />;
