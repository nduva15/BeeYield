...
const STATIC_PRODUCTS: Product[] = [
  ...
  // --- SENSORS ---
  {
    id: "s1",
    name: "BeeHUB Queen",
    description: "It monitors hive status and conditions by collecting data from connected temperature, sound, and apiary scale sensors. BeeHUB Sense communicates with BeeHUB Queen via Bluetooth, while LoRa/GSM connectivity sends measurement data to the Intelligent Hives cloud.",
    category: "hardware",
    badge: "LoRa/GSM",
  ...
  },
  {
    id: "s2",
    name: "BeeHUB Sense",
    description: "Connects directly with the BeeHUB application via Bluetooth, synchronising the measurements collected inside the hive in real time.",
    category: "hardware",
    badge: "Bluetooth",
    images: ["/images/products/beehub_temp_sensor.png"],
    rating: 4.6,
    review_count: 28,
    is_active: true,
  ...
  },
  {
    id: "s3",
    name: "BeeHUB GPS",
    description: "GPS + accelerometer theft protection with battery status monitoring, reducing the risk of losing bees and invested money.",
    category: "hardware",
    badge: "GPS + Accelerometer",
