  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const hasMappedPdf = finalData?.length === 8 && finalData.every((item) => !!getLearnMaterialByName(item.name));
                    ...
                    <div className="mt-auto pt-6 border-t border-neutral-50 flex items-center justify-between gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        {material && (
                          ...
                          >
                            <a href={`/learn-pdfs/${material.fileName}`} target="_blank" rel="noreferrer">
