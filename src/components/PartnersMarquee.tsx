...
const partners = [
  {
    name: "Farmers",
    subtitle: "Community Growers & Orchards",
    icon: Globe,
  },
  {
    name: "ApiSense",
            ...
            <motion.li key={partner.name} variants={itemVariants}>
              {partner.url ? (
                <a
                  ...
                  className="group flex h-full flex-col items-center justify-center gap-3 rounded-3xl border border-border/70 bg-background/80 px-6 py-8 text-center shadow-sm backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:shadow-lg"
                >
                  {partner.logo ? (
                ...
                <div className="flex h-full flex-col items-center justify-center gap-3 rounded-3xl border border-border/70 bg-background/80 px-6 py-8 text-center shadow-sm backdrop-blur">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-primary/15 bg-primary/5 md:h-16 md:w-16 text-primary">
