            ...
            <BeeYieldPageHeader
                ...
                actions={
                    <div className="flex gap-3">
                        ...
                        <button className={cn(glass.btnPrimary, "h-9 px-6 font-bold text-[10px] shadow-sm")}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                        ...
                        <div className="space-y-6 relative z-10">
                            <div className="flex justify-between items-start">
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="text-[10px] font-bold text-emerald-600 mt-1 tracking-wider">AVG. FOB SCORE</p>
                                </div>
                            </div>
                ...
                <div className="lg:col-span-4 space-y-6">
                            ...
                            {[
                                ...
                                <div key={item.label} className="flex items-center justify-between group cursor-pointer">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[8px] font-black opacity-60 group-hover:opacity-100 group-hover:text-[#F4D03F] transition-all">{item.label}</span>
                                    </div>
                    ...
                    >
                        ...
                        <button className={cn(glass.btnSecondary, "w-full h-9 justify-center font-bold text-[10px] shadow-sm")}>
                            Generate Link
                        </button>
                    </motion.div>
                </div>
