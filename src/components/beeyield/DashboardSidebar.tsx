            ...
            <div key={item.id} className="w-full">
                <button
                    ...
                    className={cn(
                        ...
                        isActive ? "bg-[#10b981] text-white" : "text-[#064e3b] hover:bg-[#facc15]/5",
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        <item.icon className={cn("w-4 h-4", isActive ? "text-white" : "text-[#064e3b]/40 group-hover:text-[#064e3b]")} />
                        <span className={cn(
                            "text-[10px] uppercase font-black tracking-[0.2em]",
                            isActive ? "text-white" : "text-[#064e3b]/60 group-hover:text-[#064e3b]"
                        )}>
                            {item.label}
                        </span>
                    </div>
                    {hasChildren && (
                        <div className={cn("transition-transform duration-200", isExpanded ? "rotate-180" : "rotate-0")}>
                            <ChevronDown className={cn("w-3 h-3", isActive ? "text-white" : "text-[#064e3b]/20")} />
                        </div>
                    )}
                </button>
    ...
    return (
        <>
            ...
            <button
                ...
                className="lg:hidden fixed bottom-8 right-8 z-50 w-16 h-16 bg-[#10b981] border-4 border-[#064e3b] flex items-center justify-center text-white shadow-[8px_8px_0px_0px_rgba(6,78,59,1)] active:shadow-none active:translate-x-1 active:translate-y-1 transition-all"
            >
            ...
            <aside className={cn(
                ...
                <div className="p-8 border-t-4 border-[#064e3b] bg-white space-y-4">
                    ...
                    <button
                        onClick={onLogout}
                        className="w-full h-14 border-4 border-[#064e3b] bg-[#064e3b] flex items-center gap-4 px-6 hover:bg-red-600 text-white transition-all shadow-[6px_6px_0px_0px_rgba(16,185,129,1)] active:shadow-none active:translate-x-1 active:translate-y-1"
                    >
