        ...
        >
            ...
            >
                <div className="absolute top-0 right-0 p-20 opacity-5 group-hover:opacity-20 transition-all duration-[3000ms] scale-150 rotate-12">
                    <Sparkles className="w-[800px] h-[800px] text-white" />
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 p-20 relative z-10 text-white">
                    <div className="lg:col-span-8 space-y-12">
                        <div className="space-y-8">
                            ...
                            <h2 className="text-8xl font-black italic text-white tracking-tighter uppercase leading-[0.8] italic">
                                Synthesize <br />
                                <span className="text-white/60">Hive Intelligence.</span>
                            </h2>
                            <p className="text-3xl font-black text-white/90 italic leading-relaxed border-l-8 border-white/20 pl-16 max-w-4xl uppercase tracking-tight">
                        ...
                        <div className="flex flex-col sm:flex-row gap-10 pt-8">
                            ...
                            <div className="flex items-center gap-8 px-12 border-l-2 border-white/20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 relative z-10">
                ...
                <div className="lg:col-span-8 space-y-16">
                    <motion.div
                        ...
                        className={cn(glass.card, "p-0 overflow-hidden shadow-4xl border-honey/10 bg-white/60 dark:bg-[#0D0D0D]/60 backdrop-blur-3xl rounded-[5rem] relative group")}
                    >
                        ...
                        <div className="p-16 space-y-20 relative z-10">
                                        ...
                                        <motion.div
                                            ...
                                            className={cn(
                                                ...
                                                sections[section.id as keyof typeof sections]
                                                    ...
                                                    : "bg-black/5 dark:bg-black/40 border-white/5 hover:border-honey/40"
                                            )}
                                        >
                                            <div className={cn(
                                                "w-20 h-20 rounded-[2.5rem] flex items-center justify-center transition-all duration-1000 shadow-4xl",
                                                sections[section.id as keyof typeof sections] ? "bg-honey text-black rotate-12" : "bg-black/20 text-foreground/10 group-hover/opt:bg-honey/10 group-hover/opt:text-honey"
                                            )}>
                            ...
                            <div className="space-y-12">
                                ...
                                <div className="flex flex-wrap gap-8 bg-black/10 dark:bg-black/40 p-4 rounded-[4rem] border border-white/5 w-fit shadow-4xl backdrop-blur-3xl relative overflow-hidden">
                            ...
                            <div className="pt-16 border-t border-white/10 space-y-16">
                                <div className="flex flex-col xl:flex-row gap-12 items-center justify-between">
                                    <div className="flex bg-black/10 dark:bg-black/40 p-4 rounded-[4rem] border border-white/5 gap-6 shadow-4xl backdrop-blur-3xl w-full xl:w-fit">
                                        <button
                                    ...
                                    {isGenerating && (
                                        ...
                                        >
                                            <div className="flex justify-between items-center px-8">
                                                ...
                                                <span className="text-4xl font-black italic tabular-nums tracking-tighter text-white">{Math.round(genProgress)}%</span>
                                            </div>
                                            <div className="h-6 bg-black/10 dark:bg-black/40 rounded-full overflow-hidden p-1 shadow-inner border border-white/5 relative">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                {reports.slice(0, 8).map((report, i) => (
                                    <motion.div
                                        ...
                                        className={cn(glass.card, "p-12 group hover:border-honey/60 hover:bg-honey/[0.08] hover:shadow-[0_80px_150px_-30px_rgba(251,191,36,0.3)] transition-all duration-1000 flex items-center justify-between shadow-4xl border-white/5 bg-white dark:bg-[#0D0D0D]/90 rounded-[5rem] overflow-hidden relative")}
                                    >
                                        ...
                                        <div className="flex items-center gap-10 relative z-10">
                                            <div className="w-24 h-24 rounded-[3.5rem] bg-black/10 dark:bg-black/60 flex items-center justify-center text-foreground/20 group-hover:bg-honey/20 group-hover:text-honey transition-all duration-1000 shadow-4xl border border-white/5 group-hover:scale-110 group-hover:rotate-12">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="flex items-center gap-6">
                                                    <div className="px-6 py-2 rounded-full bg-black/10 dark:bg-white/10 text-foreground/40 font-black italic text-[11px] tracking-[0.4em] uppercase border border-white/5 shadow-2xl skew-x-[-15deg]">
                                        ...
                                        <button
                                            className={cn(glass.btnSecondary, "h-20 w-20 p-0 rounded-[2.5rem] bg-white dark:bg-black/40 shadow-4xl border-white/5 hover:text-honey hover:scale-110 transition-all duration-700 relative z-10")}
                                            onClick={() => {
                                                if (report.file_url) {
                ...
                <div className="lg:col-span-4 space-y-16">
                    <motion.div
                        ...
                        className={cn(glass.card, "p-12 shadow-4xl relative overflow-hidden border-honey/10 bg-white/60 dark:bg-[#0D0D0D]/60 backdrop-blur-3xl min-h-[800px] flex flex-col rounded-[5rem] group")}
                    >
                            ...
                            <div className="space-y-10 relative z-10 flex-1">
                                {schedules.map((schedule, i) => (
                                    <motion.div
                                        ...
                                        className="bg-white/80 dark:bg-black/60 border border-white/5 p-10 rounded-[3.5rem] flex items-center justify-between group/sch hover:border-honey/60 transition-all duration-1000 shadow-4xl"
                                    >
                                        <div className="flex items-center gap-8">
                                            <div className={cn(
                                                "w-20 h-20 rounded-[2.5rem] flex items-center justify-center transition-all duration-1000 shadow-4xl",
                                                schedule.is_active ? "bg-emerald-500/10 text-emerald-500 border border-emerald-500/20" : "bg-black/40 text-foreground/20"
                                            )}>
                                        ...
                                        <button
                                            ...
                                            className="w-18 h-18 flex items-center justify-center rounded-[2rem] bg-black/5 hover:bg-red-500 text-foreground/20 hover:text-white transition-all duration-700 border border-transparent hover:border-red-500 shadow-4xl active:scale-90"
                                        >
                        ...
                        <motion.div
                            ...
                            className="mt-20 p-12 bg-black dark:bg-[#0A0A0A] rounded-[4rem] border-2 border-honey/20 space-y-8 shadow-[0_50px_100px_-20px_rgba(251,191,36,0.2)] text-white relative overflow-hidden group/proto"
                        >
                            ...
                            <p className="text-lg font-black text-white/40 leading-relaxed uppercase italic tracking-tight relative z-10 border-l-4 border-white/10 pl-10">
                ...
                {isScheduleModalOpen && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-12">
                        ...
                        <motion.div
                            ...
                            className={cn(glass.card, "w-full max-w-4xl p-0 overflow-hidden shadow-[0_100px_200px_-50px_rgba(0,0,0,0.8)] bg-white dark:bg-[#0D0D0D] border-honey/40 relative z-10 rounded-[6rem]")}
                        >
                            <div className="p-16 border-b border-white/5 flex justify-between items-center bg-black/40 backdrop-blur-3xl relative overflow-hidden">
                                ...
                                <button
                                    onClick={() => setIsScheduleModalOpen(false)}
                                    className={cn(glass.btnSecondary, "h-20 w-20 p-0 rounded-[2.5rem] bg-white dark:bg-black/60 shadow-4xl border-white/5 hover:text-red-500 hover:scale-110 transition-all duration-700 relative z-10")}
                                >
                            ...
                            <form onSubmit={handleCreateSchedule} className="p-20 space-y-16">
                                <div className="space-y-12">
                                    <div className="space-y-8">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <Input
                                                ...
                                                className={cn(glass.input, "h-24 font-black italic text-4xl pl-26 px-12 shadow-inner rounded-[3.5rem] bg-black/5 dark:bg-black/40 border-none focus:text-honey transition-all placeholder:opacity-10")}
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                        <div className="space-y-8">
                                            ...
                                            <Select value={newSchedule.frequency} onValueChange={(v: any) => setNewSchedule({ ...newSchedule, frequency: v })}>
                                                <SelectTrigger className={cn(glass.input, "h-24 px-12 font-black italic text-2xl shadow-inner rounded-[3.5rem] bg-black/5 dark:bg-black/40 border-none flex items-center gap-10")}>
                                        ...
                                        <div className="space-y-8">
                                            ...
                                            <div className={cn(glass.input, "h-24 px-12 flex items-center justify-between shadow-inner rounded-[3.5rem] bg-black/5 dark:bg-black/40")}>
                                                <div className="flex items-center gap-6">
                                    ...
                                    <div className="bg-[#FBBE24]/5 dark:bg-black/80 p-12 rounded-[4rem] border-2 border-[#FBBE24]/20 flex gap-10 items-start shadow-inner relative overflow-hidden group">
