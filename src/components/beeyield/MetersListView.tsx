...
const MetersListView: React.FC<MetersListViewProps> = ({ type, onTabChange }) => {
    ...
    const colors = {
        ...
        energy: { primary: '#F4D03F', bg: 'bg-[#F4D03F]/20', text: 'text-[#8a7300]', border: 'border-border/' },
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-12">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <h1 className="text-xl font-black tracking-tighter italic text-foreground">
            ...
            <Collapsible open={isBuildingsOpen} onOpenChange={setIsBuildingsOpen} className="w-full">
                <div className={cn(glass.card, "p-0 bg-muted/ border-border/ shadow-xl overflow-hidden")}>
                    <div className="p-5 flex items-center justify-between border-b border-border/">
                        <div>
                            <h2 className="text-[11px] font-black text-foreground flex items-center gap-2">
                                <Building2 className="w-4 h-4 text-muted-foreground/70" />
                                Apiaries
                            </h2>
                            <p className="text-[9px] font-black text-muted-foreground/70 mt-1">Overview Of Addresses With Sensor Counts</p>
                        </div>
                        <CollapsibleTrigger asChild>
                            <button className={cn(glass.btnSecondary, "h-8 px-4 font-black text-[9px] rounded-xl border-border/ flex items-center gap-2")}>
                        ...
                        <div className="p-5">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                                {buildings.map((building, i) => (
                                    <div key={i} className="bg-muted/ border border-border/ rounded-2xl p-4 shadow-sm hover:bg-muted/ transition-all group">
                                        <h4 className="text-[10px] font-black text-foreground mb-1">{building.name}</h4>
                                        <p className="text-[9px] font-bold text-muted-foreground/70 leading-tight mb-3 min-h-[2.5em]">{building.address}</p>

                                        <div className="flex gap-2 mb-3">
                                            <Badge variant="secondary" className="bg-muted/ text-foreground/60 text-[8px] px-2 py-0.5 font-black border border-border/ rounded-lg">
                                        ...
                                        <div className="space-y-1 mt-4 pt-3 border-t border-border/">
                                            <p className="text-[8px] text-muted-foreground/70 font-black">Coordinates: {building.coords}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                ...
                <div className={cn(glass.card, "p-0 bg-muted/ border-border/ shadow-xl overflow-hidden")}>
                    <div className="p-5 flex items-center justify-between border-b border-border/">
                        <div>
                            ...
                            <p className="text-[9px] font-black text-muted-foreground/70 mt-1">Hive List With Assigned Sensors</p>
                        </div>
                        <CollapsibleTrigger asChild>
                            <button className={cn(glass.btnSecondary, "h-8 px-4 font-black text-[9px] rounded-xl border-border/ flex items-center gap-2")}>
                    ...
                    <CollapsibleContent>
                        <div className="p-0">
                            <div className="divide-y divide-white/20">
                                {apartments.map((apt) => (
                                    <div key={apt.id} className="p-4 px-5 flex items-center justify-between hover:bg-muted/ transition-colors">
                                        <div>
                                            <h4 className="text-[10px] font-black text-foreground">{apt.name}</h4>
                                            <p className="text-[9px] font-bold text-muted-foreground/70 mt-0.5">{apt.location}</p>
                                        </div>
                                        <Badge variant="secondary" className="bg-muted/ text-foreground/60 text-[8px] px-2 py-0.5 font-black border border-border/ rounded-lg">
                                            Sensors: {apt.meters}
                                        </Badge>
            ...
            {/* Filters */}
            <div className={cn(glass.card, "p-5 bg-muted/ border-border/ shadow-sm")}>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    <div className="space-y-1.5">
                        <label className="text-[9px] text-foreground/50 font-black">Type</label>
                        <div className="flex gap-2 p-1 bg-muted/ border border-border/ rounded-xl h-9">
                            <button className={cn("rounded-lg h-7 w-8 flex items-center justify-center transition-all", type === 'heat' && "bg-white shadow-sm")} onClick={() => onTabChange('meters-heat')}>
                                <Flame className={cn("w-3.5 h-3.5", type === 'heat' ? "text-orange-500" : "text-muted-foreground/70")} />
                            </button>
                            <button className={cn("rounded-lg h-7 w-8 flex items-center justify-center transition-all", type === 'water' && "bg-white shadow-sm")} onClick={() => onTabChange('meters-water')}>
                                <Droplet className={cn("w-3.5 h-3.5", type === 'water' ? "text-blue-500" : "text-muted-foreground/70")} />
                            </button>
                            <button className={cn("rounded-lg h-7 w-8 flex items-center justify-center transition-all", type === 'energy' && "bg-white shadow-sm")} onClick={() => onTabChange('meters-energy')}>
                                <Zap className={cn("w-3.5 h-3.5", type === 'energy' ? "text-yellow-500" : "text-muted-foreground/70")} />
                            </button>
                        </div>
                    </div>

                    <div className="space-y-1.5">
                        <label className="text-[9px] text-foreground/50 font-black">Apiary</label>
                        <div className="relative">
                            <Building2 className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-muted-foreground/70" />
                            <select id="filter-apiary" name="apiary" className={cn(glass.select, "w-full h-9 pl-9 pr-4 bg-muted/ border-border/ focus:bg-white rounded-xl text-[9px] font-black appearance-none cursor-pointer")}>
                    ...
                    <div className="space-y-1.5">
                        <label className="text-[9px] text-foreground/50 font-black">Hive</label>
                        <div className="relative">
                            <Home className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-muted-foreground/70" />
                            <select id="filter-hive" name="hive" className={cn(glass.select, "w-full h-9 pl-9 pr-4 bg-muted/ border-border/ focus:bg-white rounded-xl text-[9px] font-black appearance-none cursor-pointer")}>
                    ...
                    <div className="space-y-1.5">
                        <label className="text-[9px] text-foreground/50 font-black">Health</label>
                        <div className="relative">
                            <Activity className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-muted-foreground/70" />
                            <select id="filter-status" name="status" className={cn(glass.select, "w-full h-9 pl-9 pr-4 bg-muted/ border-border/ focus:bg-white rounded-xl text-[9px] font-black appearance-none cursor-pointer")}>
                    ...
                    <div className="space-y-1.5">
                        <label className="text-[9px] text-foreground/50 font-black">Level</label>
                        <div className="relative">
                            <Clock className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-muted-foreground/70" />
                            <select id="filter-level" name="reading-level" className={cn(glass.select, "w-full h-9 pl-9 pr-4 bg-muted/ border-border/ focus:bg-white rounded-xl text-[9px] font-black appearance-none cursor-pointer")}>
                    ...
                    <div className="space-y-1.5">
                        <label className="text-[9px] text-foreground/50 font-black">Search</label>
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={cn(glass.input, "w-full h-9 pl-9 bg-muted/ border-border/ focus:bg-white rounded-xl text-[9px] font-black placeholder:text-muted-foreground/70")}
                                value={searchQuery}
                ...
                <div className={cn(glass.card, "p-0 bg-muted/ border-border/ shadow-xl overflow-hidden")}>
                    <div className="p-5 flex items-center justify-between border-b border-border/">
                        <div>
                            ...
                            <p className="text-[9px] font-black text-muted-foreground/70 mt-1">Download Filtered Dataset</p>
                        </div>
                        <CollapsibleTrigger asChild>
                            <button className={cn(glass.btnSecondary, "h-8 px-4 font-black text-[9px] rounded-xl border-border/ flex items-center gap-2")}>
                    ...
                    <CollapsibleContent>
                        <div className="p-6 bg-muted/">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                                <div>
                                    <h4 className="text-[9px] font-black text-muted-foreground/70 mb-4">Data Columns</h4>
                                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-y-4 gap-x-2">
                                        {columns.map(col => (
                                            <div key={col.id} className="flex items-center space-x-2">
                                                ...
                                                />
                                                <label htmlFor={col.id} className="text-[9px] font-black text-foreground leading-none cursor-pointer">
                                                    {col.label}
                                                </label>
                                            </div>
                                        ))}
                                ...
                                <div className="space-y-6">
                                    <h4 className="text-[9px] font-black text-muted-foreground/70">Output Formats</h4>
                                    <div className="flex flex-wrap gap-4">
                                        ...
                                        <button onClick={exportToXLS} className={cn(glass.btnSecondary, "h-10 flex-1 min-w-[150px] font-black text-[9px] rounded-xl border-border/ bg-muted/ hover:bg-white")}>
            ...
            {/* Meters Table */}
            <div className={cn(glass.card, "p-0 shadow-xl overflow-hidden bg-muted/ border-border/")}>
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        <thead>
                            <tr className="border-b border-border/ bg-muted/">
                                <th className="px-5 py-4 text-[8px] font-black text-muted-foreground/70">Sensor Type</th>
                                <th className="px-5 py-4 text-[8px] font-black text-muted-foreground/70">Apiary Zone</th>
                                <th className="px-5 py-4 text-[8px] font-black text-muted-foreground/70">Hive Unit</th>
                                <th className="px-5 py-4 text-[8px] font-black text-muted-foreground/70">Sensor Id</th>
                                <th className="px-5 py-4 text-[8px] font-black text-muted-foreground/70">Last Reading</th>
                                <th className="px-5 py-4 text-[8px] font-black text-muted-foreground/70">Health</th>
                                <th className="px-5 py-4 text-[8px] font-black text-muted-foreground/70">Alert</th>
                                <th className="px-5 py-4 text-[8px] font-black text-muted-foreground/70 text-right">Actions</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-white/10">
                            {meters.map((meter) => (
                                <tr key={meter.id} className="hover:bg-muted/ transition-colors group">
                                    ...
                                    <td className="px-5 py-3">
                                        <p className="text-[10px] font-black tracking-wider text-foreground">{meter.building}</p>
                                        <p className="text-[8px] font-bold text-muted-foreground/70 mt-0.5">{meter.location}</p>
                                    </td>
                                    <td className="px-5 py-3">
                                        <p className="text-[10px] font-black tracking-wider text-muted-foreground/90">{meter.apartment}</p>
                                    </td>
                                    <td className="px-5 py-3">
                                    ...
                                    <td className="px-5 py-3 text-right">
                                        <div className="flex flex-col items-end gap-2">
                                            <div className="flex items-center gap-3">
                                                <button className="flex items-center gap-1.5 text-[8px] font-black text-muted-foreground hover:text-[#1B9157] transition-colors">
