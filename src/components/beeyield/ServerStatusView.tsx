    ...
    return (
        ...
        >
            ...
            <PageHeader 
                ...
                title={<>Network <span className="text-[#F4D03F]">Status</span></>}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <GlassStatCard label="Avg Latency" value={`${avgResponseMs}ms`} icon={Clock} index={1} color="text-[#1B9157]" />
                <GlassStatCard label="Error Reports" value={errorCount} icon={AlertTriangle} index={2} color={errorCount > 0 ? "text-red-500" : "text-[#1B9157]"} />
                <GlassStatCard label="Capacity Usage" value={`${usagePercent}%`} icon={BarChart3} index={3} color="text-[#F4D03F]" />
            </div>
