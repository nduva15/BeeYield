        ...
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 relative z-10">
                ...
                <motion.div 
                    ...
                    className={cn(glass.card, "lg:col-span-8 p-0 overflow-hidden bg-white/60 dark:bg-[#0D0D0D]/60 backdrop-blur-3xl rounded-[5rem] relative")}
                >
                    <div className="p-16 border-b border-white/10 bg-white/40 dark:bg-black/40 backdrop-blur-3xl flex items-center justify-between relative z-10">
                                ...
                                <div className="grid grid-cols-1 gap-6">
                                    {topEndpoints.length > 0 ? topEndpoints.map((ep, idx) => (
                                        <motion.div 
                                            ...
                                            className="flex items-center justify-between p-10 rounded-[3.5rem] bg-black/5 dark:bg-black/40 border border-white/5 hover:border-honey/40 transition-all duration-700 shadow-4xl group"
                                        >
                                            <div className="flex items-center gap-10">
                                                <div className="w-16 h-16 rounded-[1.5rem] bg-white/40 dark:bg-black/40 flex items-center justify-center shadow-4xl border border-white/5 group-hover:scale-110 transition-transform">
                    ...
                    <div className="p-16 border-t border-white/10 bg-white/40 dark:bg-black/60 backdrop-blur-3xl flex items-center justify-between rounded-b-[5rem]">
                    ...
                    <div className="grid grid-cols-1 gap-12">
                        {apis.map((api, idx) => (
                            <motion.div
                                ...
                                animate={{ opacity: 1, x: 0 }}
                                transition={{ delay: idx * 0.1 }}
                                className={cn(glass.card, "p-12 shadow-4xl hover:border-honey/60 transition-all duration-1000 relative group overflow-hidden bg-white/60 dark:bg-[#0D0D0D]/60 backdrop-blur-3xl rounded-[4rem]")}
                            >
                                ...
                                <div className="flex justify-between items-start mb-10">
                                    <div className="space-y-4">
                                        <div className={cn(glass.badge, "bg-white/40 dark:bg-black/60 text-honey border-white/5 px-8 py-2.5 shadow-3xl skew-x-[-12deg]")}>
                                ...
                                <div className="space-y-8">
                                    <div className="space-y-2">
                                        ...
                                        <div className="font-mono text-sm text-foreground/80 bg-black/5 dark:bg-black/40 p-6 rounded-2xl border border-white/5 break-all">
                                            {api.checkPath}
                                        </div>
                                    </div>
