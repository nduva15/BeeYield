...
const SettingsIntegrationsView: React.FC = () => {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700 max-w-[1400px] mx-auto">
            ...
            {/* COMPLIANCE HEADER */}
            <div className="relative group overflow-hidden rounded-[3rem] bg-[#09090b] text-white p-12 border border-white/5 shadow-2xl">
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-10">
                    ...
                    <div className="flex items-center gap-2 px-8 py-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl">
            ...
            <Card className="rounded-[4rem] border-none bg-white dark:bg-[#060606] shadow-xl overflow-hidden min-h-[500px]">
                    ...
                    <div className="space-y-12 animate-in fade-in duration-500">
                        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
                            <div className="space-y-4">
                                ...
                                <h3 className="text-3xl font-black text-gray-900 dark:text-white uppercase tracking-tighter">eTIMS VSDC Terminal</h3>
                            ...
                            <Button
                                ...
                                className="bg-[#1B9157] hover:bg-[#167d4a] text-white rounded-[2rem] h-16 px-12 font-black text-xs uppercase tracking-widest shadow-2xl"
                            >
                            ...
                            <div className="space-y-8">
                                <div className="space-y-4">
                                    ...
                                    <Input
                                        ...
                                        className="rounded-[2rem] border-gray-100 dark:border-white/5 h-20 text-2xl font-black bg-gray-50 dark:bg-white/5 focus:bg-white text-center tracking-[0.3em]"
                                    />
                                </div>
                                <div className="space-y-4">
                                    ...
                                    <Input
                                        ...
                                        className="rounded-[2rem] border-gray-100 dark:border-white/5 h-20 text-2xl font-black bg-gray-50 dark:bg-white/5 focus:bg-white text-center"
                                    />
                                </div>
                            </div>

                            <div className="bg-[#09090b] rounded-[3rem] p-10 text-white space-y-10 shadow-2xl relative overflow-hidden">
                                ...
                                <div className="space-y-8 relative z-10">
                                    <div className="flex justify-between items-center">
                                        <span className="text-[10px] font-bold text-white/40 uppercase">Authorized Hub</span>
                                        <span className="text-sm font-black text-[#1B9157]">BeeYield-VSDC-v2</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="text-[10px] font-bold text-white/40 uppercase">Last Handshake</span>
                                        <span className="text-sm font-black">{getSyncDate('etims')}</span>
                                    </div>
                                    <div className="pt-6 border-t border-white/5">
                                        <div className="flex justify-between items-center mb-4">
                                            <span className="text-[10px] font-bold text-white/30 uppercase">Uptime Stability</span>
            ...
            {/* SECURITY ASSURANCE */}
            <div className="p-10 rounded-[3rem] border border-gray-100 dark:border-white/5 flex flex-col md:flex-row items-center justify-between gap-8">
