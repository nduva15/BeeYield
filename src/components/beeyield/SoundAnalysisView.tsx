        ...
        <div className={cn(glass.page, "p-8 -m-8 min-h-screen")}>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 pb-8">
                <div className="space-y-4">
                    ...
                    <h1 className={cn(glass.sectionTitle, 'text-6xl')}>
                        Acoustic <span className="text-[#F4D03F]">Audit</span>
                    </h1>
                ...
                <div className="flex items-center gap-3">
                    <div className={cn(glass.badge, "px-6 py-3 border-[#1B9157]/ bg-[#1B9157]/ text-[#1B9157] shadow-lg shadow-emerald-500/5")}>
                        SPECTRUM: 100-800HZ
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-5 space-y-8 flex flex-col">
                    <div className={cn(glass.card, "p-8 flex flex-col gap-8")}>
                        <div className="flex items-center gap-4 border-b border-border pb-6">
                            <div className="w-12 h-12 rounded-[1.5rem] bg-[#F4D03F]/10 flex items-center justify-center border border-[#F4D03F]/20 shadow-inner">
                                <Terminal className="w-6 h-6 text-[#F4D03F]" />
                            </div>
                            <h3 className={cn(glass.sectionTitle, "text-3xl normal-case")}>Audio Node</h3>
                        </div>

                        <p className={cn(glass.microLabel, "text-muted-foreground leading-relaxed italic border-l-2 border-[#F4D03F]/50 pl-4")}>
                        ...
                        <div className="flex flex-col gap-4 mt-auto">
                            <button
                                ...
                                className={cn(
                                    ...
                                    recording ? "bg-destructive text-[#1A1A1A] border-destructive hover:bg-destructive shadow-destructive/20 scale-[0.98] ring-4 ring-destructive/20" : "hover:border-[#F4D03F] hover:shadow-xl hover:shadow-honey/10"
                                )}
                            >
                        ...
                        {analyzing && (
                            ...
                            >
                                <div className="flex justify-between items-end mb-4">
                                    ...
                                    <span className={cn(glass.sectionTitle, "text-3xl tabular-nums leading-none text-[#F4D03F]")}>{progress}%</span>
                                </div>
                        ...
                        {result && !analyzing && (
                            <motion.div
                                ...
                                className={cn(
                                    ...
                                    result === 'Healthy' ? "border-[#1B9157]/ bg-[#1B9157]/ shadow-emerald-500/10" : "border-red-500/30 bg-red-500/5 shadow-red-500/10"
                                )}
                            >
                                <div className={cn("absolute inset-0 opacity-10 blur-3xl", result === 'Healthy' ? "bg-[#1B9157]" : "bg-red-500")} />
                                <div className="relative z-10 flex items-center gap-5">
                                    <div className={cn(
                                        "w-16 h-16 rounded-[1.5rem] flex items-center justify-center shadow-lg",
                                        result === 'Healthy' ? "bg-[#1B9157]/ text-[#1B9157]" : "bg-red-500/20 text-red-500"
                                    )}>
                                        {result === 'Healthy' ? <ShieldCheck className="w-8 h-8" /> : <AlertCircle className="w-8 h-8" />}
                                    </div>
                                    <h4 className={cn(glass.sectionTitle, "text-4xl normal-case tracking-tight", result === 'Healthy' ? "text-[#1B9157]" : "text-red-500")}>
                                        {result}
                                    </h4>
                                </div>
                ...
                <div className={cn(glass.card, "p-0 overflow-hidden lg:col-span-7 flex flex-col group")}>
                    <div className="flex items-center justify-between p-8 border-b border-border bg-gray-300">
                        <div className="flex items-center gap-4">
                            <Activity className="w-6 h-6 text-[#F4D03F]" />
                            <h3 className={cn(glass.sectionTitle, "text-3xl normal-case")}>Spectral Wave</h3>
                        </div>
                        <div className={cn(glass.badge, "bg-[#1B9157]/ text-[#1B9157] border-[#1B9157]/ shadow-emerald-500/10")}>LIVE_FEED</div>
                    </div>
                            ...
                            {[...Array(40)].map((_, i) => (
                                <motion.div
                                    ...
                                    className={cn(
                                        ...
                                        recording ? "bg-destructive/80" : (analyzing ? "bg-[#F4D03F]/80" : "bg-muted-foreground/20")
                                    )}
                                    animate={{
                    ...
                    <div className="p-8 border-t border-border bg-muted/20 grid grid-cols-2 gap-8 divide-x divide-border">
                        ...
                        <div className="space-y-3 pl-8 text-right">
                            ...
                            <p className={cn(glass.sectionTitle, "text-4xl tabular-nums tracking-tight text-[#1B9157]")}>94.8%</p>
                        </div>
                    </div>
                </div>
            </div>
