        ...
        <BeeYieldPageShell embedded={embedded}>
            ...
            <BeeYieldPageHeader
                ...
                action={
                    <div className={cn(glass.card, "p-1 overflow-hidden inline-flex bg-background/50 shadow-emerald-500/10 shadow-lg")}>
                        <div className="px-5 py-2 bg-muted/ flex items-center gap-3 backdrop-blur-md rounded-xl">
                            <Waves className="w-4 h-4 text-[#1B9157] animate-pulse" />
                            <span className={cn(glass.microLabel, "font-bold text-foreground")}>Listening</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 relative">
                ...
                >
                    ...
                    <div className="p-5 flex items-center justify-between border-b border-border/ bg-muted/ relative z-10">
                        <div>
                    ...
                    <div className="grid grid-cols-3 gap-5 p-5 border-t border-border/ bg-muted/ relative z-10">
                        <div className="space-y-1">
                            <p className={glass.microLabel}>Lower frequency</p>
                            <p className="text-xl font-bold tracking-tight text-foreground">Stable</p>
                        </div>
                        <div className="space-y-1">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-xl font-bold tracking-tight text-foreground">Normal</p>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className="space-y-8 flex flex-col justify-between">
                    <motion.div
                        ...
                        className={cn(glass.card, "p-5 shadow-xl bg-gradient-to-br from-[#F4D03F]/5 to-[#1B9157]/5 border-border/ group relative overflow-hidden")}
                    >
                        ...
                        <div className="flex items-center gap-4 mb-6 relative z-10">
                            <div className="w-10 h-10 rounded-lg bg-[#F4D03F]/10 flex items-center justify-center border border-border/ shadow-sm">
                        ...
                        <div className="space-y-6 relative z-10">
                            ...
                            <p className="text-[11px] font-bold opacity-60 text-foreground leading-relaxed">
                    ...
                    <motion.div
                        ...
                        className={cn(glass.card, "p-5 shadow-xl flex-1 flex flex-col justify-center relative overflow-hidden group border-border/ bg-muted/")}
                    >
                        ...
                        <div className="flex items-center gap-4 mb-6 relative z-10">
                            <div className="w-10 h-10 rounded-lg bg-muted/ flex items-center justify-center border border-border/ shadow-sm">
                        ...
                        <div className="space-y-6 relative z-10">
                            <div className="flex justify-between items-end border-b border-border/ pb-4">
                                <div>
                                    ...
                                    <p className="text-xl font-bold tracking-tight tabular-nums text-foreground">98%</p>
                                </div>
            ...
            <motion.div
                ...
                className={cn(glass.card, "p-5 shadow-xl bg-muted/ border-border/ flex flex-col md:flex-row items-start md:items-center gap-6 relative overflow-hidden group mt-8")}
            >
                <div className="absolute right-0 top-0 w-64 h-64 bg-[#F4D03F]/5 rounded-full blur-[60px] pointer-events-none transition-colors" />
                <div className="w-12 h-12 rounded-xl bg-muted/ flex items-center justify-center shrink-0 border border-border/ shadow-sm relative z-10">
                    <Info className="w-6 h-6 text-[#F4D03F]" />
                </div>
                <div className="relative z-10">
                    <h5 className={glass.sectionTitle}>Analysis Summary</h5>
                    <p className={cn(glass.microLabel, "normal-case tracking-normal leading-relaxed text-foreground/80 mt-1")}>
