...
const AnalyticsSection: React.FC<{ currency: string }> = ({ currency }) => {
    ...
    return (
        ...
        >
            <BeeYieldCard
                padded={false}
                className={cn("p-5 border-border/ bg-muted/ backdrop-blur-xl rounded-[2.5rem] shadow-xl relative overflow-hidden")}
            >
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4 border-b border-[#1A1A1A]/5 pb-4 relative z-10">
                <div className="space-y-0.5">
                    <h3 className="text-lg font-bold text-foreground tracking-tight">Financial overview</h3>
                    <p className="text-sm text-muted-foreground">Revenue, costs, and invoices</p>
                </div>
                <button
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={cn(glass.card, "p-5 flex items-center gap-4 border-border/ bg-muted/ backdrop-blur-xl rounded-[2rem] group text-left transition-all hover:border-border/ hover:shadow-xl")}
                                    >
                                        <div className="w-9 h-9 rounded-xl flex items-center justify-center border border-border/ bg-white shadow-sm group-hover:scale-105 transition-transform">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                ...
                                <div className="relative group w-full md:w-72">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-9 bg-white border border-gray-200 rounded-xl pl-9 pr-4 text-[11px] font-medium text-foreground outline-none focus:ring-1 focus:ring-[#1B9157]/30 transition-all"
                                    />
                                </div>
                            </div>

                            <div className={cn(glass.card, "p-0 overflow-hidden bg-muted/ backdrop-blur-md rounded-2xl min-h-[400px] shadow-sm")}>
                                    ...
                                    <table className="w-full">
                                        <thead className="bg-gray-50/50">
                                            <tr>
                                                ...
                                                <th className="px-6 py-3 text-left text-xs font-semibold text-muted-foreground text-right">Actions</th>
                                            </tr>
                                        </thead>
                                                ...
                                                <tr key={i} className="hover:bg-gray-50/30 transition-colors group">
                                                    ...
                                                    <td className="px-6 py-4 text-right">
                                                        <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                            ...
                                                            <button
                                                                className="h-8 w-8 rounded-lg bg-white border border-gray-100 flex items-center justify-center text-muted-foreground/70 hover:text-red-500 transition-colors shadow-sm"
                            ...
                            <div className={cn(glass.card, "p-6 relative overflow-hidden group border-gray-100 bg-muted/ backdrop-blur-md rounded-2xl shadow-sm")}>
                                ...
                                <div className="relative z-10 flex flex-col md:flex-row gap-6 items-center">
                                    ...
                                    <div className="flex flex-col items-center md:items-end gap-1.5">
                                        <div className="text-2xl font-bold text-foreground tracking-tight">1,200 <span className="text-xs font-semibold opacity-60">{currency}/mo</span></div>
                                        <div className="flex items-center gap-2 bg-gray-50 px-3 py-1 rounded-lg border border-gray-100 text-xs font-semibold text-muted-foreground">
                        ...
                        <motion.div initial={{ opacity: 0, scale: 0.95, y: 30 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 30 }} className={cn(glass.card, "w-full max-w-xl p-0 overflow-hidden shadow-2xl bg-white border-gray-100 relative z-10 rounded-3xl")}>
                            <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                                ...
                                <button
                                    ...
                                    className="h-9 w-9 flex items-center justify-center rounded-xl bg-white border border-gray-200 text-muted-foreground/70 hover:text-red-500 transition-colors shadow-sm"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-4">
                                        <div className="space-y-1.5">
                                            <Label className="text-sm font-semibold text-muted-foreground/90 ml-1">Type</Label>
                                            <div className="flex bg-gray-100/50 p-1 rounded-xl border border-gray-100 gap-1">
                                                {['invoice', 'receipt', 'expense'].map(t => (
                                                    <button key={t} onClick={() => setNewDocType(t)} className={cn("h-8 flex-1 rounded-lg text-sm font-semibold transition-all capitalize", newDocType === t ? "bg-white text-foreground shadow-sm border border-gray-100" : "text-muted-foreground")}>{t}</button>
                                                ))}
                                            </div>
                                        </div>
                                        <div className="space-y-1.5">
                                            <Label className="text-sm font-semibold text-muted-foreground/90 ml-1">Amount ({currency})</Label>
                                            <div className="relative">
                                                <DollarSign className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground/70" />
                                ...
                                <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-6 border-t border-gray-100">
                                    ...
                                    <div className="flex gap-3 w-full md:w-auto">
                                        <Button
                                            ...
                                            className="h-10 flex-1 md:px-6 rounded-xl text-sm font-semibold text-muted-foreground hover:text-foreground"
                                        >
                                            Cancel
                                        </Button>
