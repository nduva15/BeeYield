...
4. **ROI Estimate** — projected yield uplift in tons or kg per acre, marketable value vs hive rental cost.`;
  ...
  return (
    <div className={embedded ? "relative w-full h-full min-h-[600px] bg-background overflow-hidden flex flex-col rounded-xl border border-border" : "fixed inset-0 z-50 bg-background/95 backdrop-blur-sm overflow-y-auto custom-scroll"}>
      <div className={`max-w-5xl mx-auto p-6 ${embedded ? "overflow-y-auto w-full h-full" : ""}`}>
