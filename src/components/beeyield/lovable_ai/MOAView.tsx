...
4. **48-Hour Decision** — single clear go/no-go recommendation.`;
  ...
  return (
    <div className={embedded ? "h-full w-full bg-background rounded-2xl border border-border/50 overflow-hidden flex flex-col" : "fixed inset-0 z-50 bg-background overflow-hidden flex flex-col"}>
      {/* Header */}
