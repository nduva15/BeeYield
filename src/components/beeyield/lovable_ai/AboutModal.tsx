...
export default function AboutModal({ open, onOpenChange }: AboutModalProps) {
  return (
    <GlassModal
      ...
      subtitle="Knowledge system for bees, honey, and pollination."
      maxWidth="max-w-2xl"
    >
      <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-2 custom-scroll">
        <p className="text-sm text-muted-foreground leading-relaxed">
          BeeYield AI is a comprehensive bee knowledge system powered by curated datasets covering apiculture, entomology, and pollination science — from species identification to disease treatment protocols and global industry statistics.
        </p>
        ...
        <div className="p-4 rounded-xl border border-primary/20 bg-primary/5">
          ...
          <ul className="text-xs text-muted-foreground space-y-1.5">
            <li>Oldest honey found: <span className="text-foreground font-medium">5,500 years</span> (Egyptian tombs)</li>
            <li>Largest bee: <span className="text-foreground font-medium">Megachile pluto</span> (≈38mm wingspan)</li>
            <li>Fastest bee: <span className="text-foreground font-medium">Carpenter bee</span> (≈30 mph)</li>
            <li>Top producer: <span className="text-foreground font-medium">China</span> (≈446,000 MT/year)</li>
            <li>Honey bee genome sequenced: <span className="text-foreground font-medium">2006</span></li>
            <li>Brood temperature: <span className="text-foreground font-medium">35°C</span> maintained year-round</li>
            <li>Pollination value: <span className="text-foreground font-medium">$235–577B USD</span> globally</li>
          </ul>
        </div>
