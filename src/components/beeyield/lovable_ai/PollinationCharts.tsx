            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center">
                <div className="h-[350px] w-full md:w-1/2">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie data={REGIONAL_VALUE} dataKey="value" nameKey="region" cx="50%" cy="50%" outerRadius={130} label={({ region, value }: any) => `${region}: $${value}B`} labelLine={{ stroke: "hsl(var(--muted-foreground))" }} style={{ fontSize: 10 }}>
