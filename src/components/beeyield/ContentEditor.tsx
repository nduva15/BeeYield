...
const ContentEditor = () => {
    ...
    const handleGenerateChapter = async () => {
        ...
        try {
            ...
            toast.success("Chapter generated by AI");

            // Update local
            const updatedChapters = chapters.map(c =>
                c.id === activeChapterId ? { ...c, content_markdown: content, content_html: content, status: 'complete' } : c
            );
            setChapters(updatedChapters);
                    ...
                    {activeChapter ? (
                        <>
                            ...
                            <div className="px-6 py-2 bg-muted/20 border-b flex items-center gap-2">
                                ...
                                <Input
                                    placeholder="AI Instruction: e.g., 'Focus on sustainable practices and include a data table comparing yields'"
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2 text-xs">
                                    ...
                                    <span>GEO (AI): {analysis.geo.score}</span>
                                </div>
                            </div>
