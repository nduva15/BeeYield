            ...
            <div className="border-b-4 border-[#064e3b] p-10 flex flex-col xl:flex-row gap-8 items-start xl:items-center justify-between shrink-0 bg-[#facc15]/5">
                <div className="space-y-2">
                    <div className="inline-flex items-center gap-2 px-3 py-1 border-2 border-[#10b981] bg-[#064e3b]">
                        ...
                        <span className="text-[10px] font-black text-[#1A1A1A]">Health & Biology DB</span>
                    </div>
                    <h1 className="text-4xl md:text-5xl font-black text-[#064e3b] tracking-tighter leading-none">
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 w-full xl:w-auto">
                    <div className="flex flex-col gap-2 w-full md:w-80 relative z-50">
                        <span className="text-[9px] font-black text-[#064e3b]/60">
                        ...
                        >
                            <SelectTrigger className="w-full h-14 border-4 border-[#064e3b] bg-[#FFF9F0] rounded-none font-black text-xs text-[#064e3b] shadow-[4px_4px_0px_0px_rgba(6,78,59,1)]">
                            ...
                            <SelectContent className="border-4 border-[#064e3b] rounded-none shadow-[6px_6px_0px_0px_rgba(6,78,59,1)]">
                                {diseaseData.map(d => (
                                    <SelectItem key={d.id} value={d.id} className="font-bold text-xs focus:bg-[#facc15]/20 focus:text-[#064e3b]">{d.name}</SelectItem>
                                ))}
                            </SelectContent>
                        </Select>
                    </div>
                    ...
                    <div className="flex flex-col gap-2 w-full md:w-80 relative z-40">
                        ...
                        >
                            ...
                            <SelectContent className="border-4 border-[#064e3b] rounded-none shadow-[6px_6px_0px_0px_rgba(6,78,59,1)]">
                                {speciesData.map(s => (
                                    <SelectItem key={s.id} value={s.id} className="font-bold text-xs focus:bg-[#facc15]/20 focus:text-[#064e3b]">{s.name}</SelectItem>
                                ))}
                            </SelectContent>
                        </Select>
                    </div>
                ...
                <div className="w-full max-w-5xl">
                    {loadError && (
                        <div className="border-4 border-[#064e3b] bg-white p-6 shadow-[6px_6px_0px_0px_rgba(6,78,59,1)] mb-10">
                            <p className="text-sm font-black text-red-600">Load error</p>
                    ...
                    {loading && (
                        <div className="border-4 border-[#064e3b] bg-white p-10 shadow-[6px_6px_0px_0px_rgba(6,78,59,1)] mb-10 flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-sm font-black">Loading health guide…</p>
                    ...
                    {!loading && !selectedItem && diseaseData.length === 0 && speciesData.length === 0 && (
                        <div className="border-4 border-[#064e3b] bg-white p-10 shadow-[6px_6px_0px_0px_rgba(6,78,59,1)] mb-10">
                            <p className="text-sm font-black">No entries yet</p>
                        ...
                        <div className="space-y-8 animate-in fade-in duration-500 pb-20">
                            <div className="flex items-center justify-between flex-wrap gap-4">
                                <div className="space-y-1">
                                    <h2 className="text-2xl md:text-3xl font-black tracking-tighter text-[#064e3b]">
                                        Bee <span className="text-[#10b981]">Species</span>
                                    </h2>
                                    <p className="text-[10px] font-black text-[#064e3b]/60">
                                        Visual species reference gallery
                                    </p>
                                </div>
                                <Button
                                    onClick={() => setShowSpeciesGallery((v) => !v)}
                                    className="h-12 px-6 border-4 border-[#064e3b] bg-[#facc15] hover:bg-[#10b981] text-[#064e3b] hover:text-[#1A1A1A] transition-all shadow-[6px_6px_0px_0px_rgba(6,78,59,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 font-black"
                                >
                                    ...
                                    {speciesData.map((s) => (
                                        ...
                                        >
                                            <CardHeader className="border-b-4 border-[#064e3b] bg-[#facc15]/10">
                                                <CardTitle className="text-xl font-black tracking-tight text-[#064e3b] flex items-center justify-between gap-4">
                                                    <span>{s.commonName}</span>
                                                    <span className="text-[10px] font-black text-[#10b981]">{s.code}</span>
                                                </CardTitle>
                                            </CardHeader>
                                            <CardContent className="p-6 space-y-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="text-sm font-black text-[#064e3b]">{s.name}</p>
                                                        <p className="text-[10px] font-black text-[#064e3b]/60">{s.suitability}</p>
                                                    </div>
                                                </div>

                                                <div className="space-y-2">
                                                    <p className="text-[10px] font-black text-[#064e3b]/60">Traits</p>
                                                    <div className="flex flex-wrap gap-2">
                                                        {s.traits.slice(0, 6).map((t: string) => (
                                                            <span key={t} className="px-3 py-1 border-2 border-[#064e3b] bg-white text-[10px] font-black text-[#064e3b]">
                                                                {t}
                                                            </span>
                                                        ))}
                                                    </div>
                                                ...
                                                <div className="pt-4 border-t-4 border-[#064e3b] flex justify-end">
                                                    <Button
                                                        ...
                                                        className="h-11 px-6 border-4 border-[#064e3b] bg-[#facc15] hover:bg-[#10b981] text-[#064e3b] hover:text-[#1A1A1A] transition-all shadow-[4px_4px_0px_0px_rgba(6,78,59,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 font-black"
                                                    >
                                                        View Details
                                                    </Button>
                                                </div>
                    ...
                    {selectedItem ? (
                            ...
                            <div className="space-y-8">
                                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div className="space-y-1">
                                            <div className="flex items-center gap-3">
                                                <h2 className="text-4xl md:text-5xl font-black tracking-tighter text-[#064e3b] leading-tight">{selectedItem.name}</h2>
                                            </div>
                                    ...
                                    <Button
                                        ...
                                        className="h-14 px-8 border-4 border-[#064e3b] bg-[#facc15] hover:bg-[#10b981] text-[#064e3b] hover:text-[#1A1A1A] transition-all shadow-[6px_6px_0px_0px_rgba(6,78,59,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 font-black shrink-0"
                                    >
                                    ...
                                    <div className="space-y-10">
                                        <section className="space-y-6">
                                            <div className="flex items-center gap-3 border-[#064e3b] border-l-8 pl-6">
                                                ...
                                                <h3 className="text-3xl font-black tracking-tighter">Causes & Effects</h3>
                                            </div>
                                            <div className="p-8 border-4 border-[#064e3b] bg-[#FFF9F0] shadow-[6px_6px_0px_0px_rgba(6,78,59,1)] space-y-6">
                                                <div>
                                                    <span className="text-[10px] font-black text-[#10b981]">Primary Cause</span>
                                                    <p className="text-sm font-bold mt-2">{selectedItem.causes}</p>
                                                </div>
                                                <div className="h-0.5 bg-[#064e3b]/10" />
                                                <div>
                                                    <span className="text-[10px] font-black text-red-500">Known Effects</span>
                                        ...
                                        <section className="space-y-6">
                                            <div className="flex items-center gap-3 border-[#facc15] border-l-8 pl-6">
                                                ...
                                                <h3 className="text-3xl font-black tracking-tighter">Signs & Symptoms</h3>
                                            </div>
                                            <ul className="space-y-4">
                                                {selectedItem.symptoms.map((symptom: string, i: number) => (
                                                    <li key={i} className="flex gap-4 items-center p-4 bg-neutral-50 border-4 border-[#064e3b] shadow-[4px_4px_0px_0px_rgba(6,78,59,1)]">
                                                        ...
                                                        <span className="text-xs font-black">{symptom}</span>
                                                    </li>
                                                ))}
                                            </ul>
                                        </section>
                                    ...
                                    <div className="space-y-10">
                                        <section className="space-y-6">
                                            <div className="flex items-center gap-3 border-[#10b981] border-l-8 pl-6">
                                                ...
                                                <h3 className="text-3xl font-black tracking-tighter">Treatment & Management</h3>
                                            </div>
                                            <div className="p-8 border-4 border-[#064e3b] bg-[#064e3b] text-[#1A1A1A] shadow-[8px_8px_0px_0px_rgba(16,185,129,1)]">
                                                <p className="text-sm font-black tracking-loose leading-relaxed">{selectedItem.treatment}</p>
                                            </div>
                                        </section>
                                        ...
                                        <section className="space-y-6">
                                            <div className="flex items-center gap-3 border-[#064e3b] border-l-8 pl-6">
                                                ...
                                                <h3 className="text-3xl font-black tracking-tighter">Prevention Strategies</h3>
                                            </div>
                                            <div className="p-8 border-4 border-[#064e3b] bg-neutral-50 shadow-[8px_8px_0px_0px_rgba(6,78,59,1)]">
                                                <p className="text-sm font-black text-[#064e3b] tracking-loose leading-relaxed">{selectedItem.prevention}</p>
                                            </div>
                                        </section>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                    <section className="space-y-8">
                                        <div className="flex items-center gap-3 border-[#064e3b] border-l-8 pl-6">
                                            ...
                                            <h3 className="text-3xl font-black tracking-tighter">Characteristics & Traits</h3>
                                        </div>
                                        <ul className="space-y-4">
                                            {selectedItem.traits.map((trait: string, i: number) => (
                                                <li key={i} className="flex gap-4 items-center p-6 border-4 border-[#064e3b] bg-[#FFF9F0] shadow-[6px_6px_0px_0px_rgba(6,78,59,1)]">
                                                    <div className="w-4 h-4 bg-[#facc15]" />
                                                    <span className="text-sm font-black">{trait}</span>
                                                </li>
                                            ))}
                                        </ul>
                                    </section>
                                    <section className="space-y-8">
                                        <div className="flex items-center gap-3 border-[#10b981] border-l-8 pl-6">
                                            ...
                                            <h3 className="text-3xl font-black tracking-tighter">Locations & Habitats</h3>
                                        </div>
                                        <div className="p-10 border-4 border-[#064e3b] bg-[#064e3b] text-[#1A1A1A] shadow-[10px_10px_0px_0px_rgba(16,185,129,1)]">
                                            <span className="block text-[10px] text-[#facc15] font-black mb-4">Natural / Adapted Domain</span>
                                            <p className="text-2xl font-black tracking-tighter">{selectedItem.suitability}</p>
                                        </div>
                                    </section>
                                </div>
                            )}
                        ...
                        <div className="flex flex-col items-center justify-center text-center space-y-8 py-32 opacity-50">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-4xl font-black tracking-tighter text-[#064e3b]">Database Awaiting</h3>
                                <p className="text-[#064e3b]/50 font-black text-[10px]">Select an entry from the dropdowns above.</p>
                            </div>
                        </div>
                    )}
                </div>
