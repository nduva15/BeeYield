    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                toast.error("Failed to load apiary data");
            }
        };
        ...
        return (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-24 relative min-h-[600px]">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-[2.5rem] font-bold text-[#0F172A] dark:text-white tracking-tight">Add Task</h1>
                </div>
                ...
                <div className="bg-white dark:bg-[#09090b] p-8 rounded-[2.5rem] shadow-sm border border-slate-100 dark:border-slate-800 space-y-8 max-w-4xl">
                    ...
                    <div className="space-y-2">
                        <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Title<span className="text-red-500">*</span></label>
                        <input
                            type="text"
                            value={title}
                            onChange={(e) => setTitle(e.target.value)}
                            placeholder="Enter task title..."
                            className="w-full h-14 bg-slate-50 dark:bg-slate-900 border-none rounded-2xl px-6 font-bold text-slate-700 dark:text-slate-200 outline-none focus:ring-2 focus:ring-[#FDBA31] transition-all font-sans text-lg placeholder:text-slate-300"
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* Date */}
                        <div className="space-y-2">
                            <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Date<span className="text-red-500">*</span></label>
                            <Popover>
                                <PopoverTrigger asChild>
                                    <button
                                        type="button"
                                        className="w-full h-14 bg-slate-50 dark:bg-slate-900 border-none rounded-2xl px-6 font-bold text-slate-700 dark:text-slate-200 outline-none focus:ring-2 focus:ring-[#FDBA31] transition-all font-sans flex items-center justify-between group"
                                    >
                                        <span>{format(taskDate, "dd MMM yyyy")}</span>
                                        <CalendarIcon className="w-5 h-5 text-slate-300 group-hover:text-[#FDBA31] transition-colors" />
                                    </button>
                                </PopoverTrigger>
                        ...
                        <div className="space-y-2">
                            ...
                            <Popover onOpenChange={(open) => !open && setIsClockMinutes(false)}>
                                <PopoverTrigger asChild>
                                    ...
                                    >
                                        <span>{taskTime}</span>
                                        <ClockIcon className="w-5 h-5 text-slate-300 group-hover:text-[#FDBA31] transition-colors" />
                                    </button>
                                </PopoverTrigger>
                                <PopoverContent className="w-[320px] p-0 rounded-[2.5rem] border-slate-100 shadow-2xl z-[100]" align="start">
                                    <div className="p-8 space-y-6 flex flex-col items-center select-none">
                                        <div className="flex items-center justify-between w-full border-b border-slate-50 pb-4">
                                            ...
                                            <div className="flex gap-1 items-center">
                                                <button
                                                    ...
                                                    className={cn("text-xl font-black", !isClockMinutes ? "text-[#FDBA31]" : "text-slate-300")}
                                                >
                                                    {taskTime.split(':')[0]}
                                                </button>
                                        ...
                                        <div className="relative w-48 h-48 bg-slate-50 rounded-full flex items-center justify-center shadow-inner">
                                            <div className="w-2 h-2 rounded-full bg-[#FDBA31] z-10" />
                                            {isClockMinutes ? (
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            className={cn(
                                                                ...
                                                                isSelected ? "bg-[#FDBA31] text-slate-900 shadow-lg" : "text-slate-400 hover:bg-white hover:text-[#FDBA31]"
                                                            )}
                                                            style={{ left: `${x}%`, top: `${y}%` }}
                                                        >
                                                            {m}
                        ...
                        {/* Apiary */}
                        <div className="space-y-2">
                            <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Apiary</label>
                            <div className="relative">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <MapPin className="w-5 h-5 text-slate-300 group-hover:text-[#FDBA31]" />
                                        <span>{selectedApiary ? selectedApiary.name : "None"}</span>
                                    </div>
                                    ...
                                    {isApiaryOpen && (
                                        ...
                                        >
                                            <button
                                                ...
                                                className="w-full flex items-center gap-3 px-4 py-3 hover:bg-[#FFF8E7] dark:hover:bg-amber-900/20 rounded-xl transition-colors text-slate-600 dark:text-slate-300 font-bold text-sm"
                                            >
                                                <span>None</span>
                                                {!selectedApiary && <Check className="w-4 h-4 ml-auto text-[#FDBA31]" />}
                                            </button>
                                            {apiaries.map(apiary => (
                                                <button
                                                    key={apiary.id}
                                                ...
                                                >
                                                    ...
                                                    {selectedApiary?.id === apiary.id && <Check className="w-4 h-4 ml-auto text-[#FDBA31]" />}
                                                </button>
                                            ))}
                                        </motion.div>
                                    )}
                        ...
                        {/* Hive */}
                        <div className="space-y-2">
                            <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Hive</label>
                            <div className="relative">
                                <button
                                    type="button"
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <Box className="w-5 h-5 text-slate-300 group-hover:text-[#FDBA31]" />
                                        <span>{selectedHive ? selectedHive.hive_code : "None"}</span>
                                    </div>
                                ...
                                <AnimatePresence>
                                    {isHiveOpen && (
                                        ...
                                        >
                                            ...
                                            >
                                                <span>None</span>
                                                {!selectedHive && <Check className="w-4 h-4 ml-auto text-[#FDBA31]" />}
                                            </button>
                                            {hives
                                                ...
                                                .map(hive => (
                                                    ...
                                                    >
                                                        ...
                                                        {selectedHive?.id === hive.id && <Check className="w-4 h-4 ml-auto text-[#FDBA31]" />}
                                                    </button>
                                                ))}
                                        </motion.div>
                                    )}
                                ...
                                {['Inspection', 'Feeding', 'Harvest', 'General'].map((cat) => (
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            category === cat
                                                ? "bg-[#FDBA31] text-slate-900 shadow-lg shadow-amber-200"
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="w-full min-h-[120px] bg-slate-50 dark:bg-slate-900 border-none rounded-[2rem] p-6 font-medium text-slate-700 dark:text-slate-200 outline-none focus:ring-4 focus:ring-[#FDBA31]/20 transition-all resize-none leading-relaxed font-sans placeholder:text-slate-300"
                    ...
                    <div className="flex items-center gap-4 pt-6">
                        <Button
                            onClick={handleSave}
                            disabled={isSaving}
                            className="flex-1 h-14 rounded-xl bg-[#FDBA31] hover:bg-[#e5a82c] text-slate-900 font-bold text-lg shadow-lg shadow-amber-200 dark:shadow-none disabled:opacity-70"
                        >
                            {isSaving ? <Loader2 className="animate-spin" /> : "Save Task"}
                        </Button>
                        <Button
                            variant="outline"
                            onClick={() => setIsAddingTask(false)}
                            className="px-8 h-14 rounded-xl border-2 border-slate-200 dark:border-slate-700 font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800"
                        >
                            Go Back
                        </Button>
                    </div>
            ...
            <div className="relative">
                        ...
                        <div className="flex items-center justify-between p-6 bg-[#FEF9E7] dark:bg-[#1a1a1a]">
                            <div className="flex gap-2">
                                <Button
                                    ...
                                    size="icon"
                                    className="w-10 h-10 rounded-lg bg-[#FDBA31] hover:bg-[#e5a82c] text-slate-800 border-none"
                                >
                                    ...
                                    {generateCalendarDays().map((day, i) => {
                                        ...
                                        return (
                                            <div
                                                key={i}
                                                className={cn(
                                                    "min-h-[100px] p-2 text-right border-r border-b border-amber-100/50 dark:border-gray-800 relative group cursor-pointer hover:bg-white/50 transition-colors",
                                                    !isCurrentMonth && "bg-slate-50/50 dark:bg-black/20"
                                                )}
                                            >
                                                <span className={cn(
                                                    "text-sm font-medium block",
                                                    isCurrentMonth ? "text-[#3b82f6]" : "text-[#3b82f6]/30",
                                                    isTodayDate && "bg-[#3b82f6] text-white w-7 h-7 rounded-full flex items-center justify-center ml-auto"
                                                )}>
                                                    {getDate(day)}
                                                </span>
                                            </div>
                                ...
                                <div className="p-6 space-y-4">
                                    {eachDayOfInterval({
                                        ...
                                        .map((monday, i) => {
                                            ...
                                            return (
                                                <div key={i} className="bg-white dark:bg-[#1a1a1a] p-4 rounded-xl border border-amber-100 dark:border-gray-800 shadow-sm">
                                                    <div className="flex items-center justify-between mb-3">
                                                        <h3 className="text-lg font-bold text-slate-700 dark:text-slate-200">
                                                            Week {format(monday, 'do')} - {format(sunday, 'do')}
                                                        </h3>
                                                        <span className="text-xs font-semibold text-[#FDBA31] bg-[#FDBA31]/10 px-3 py-1 rounded-full uppercase tracking-wider">
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <div className="p-4 bg-slate-50 dark:bg-black/20 rounded-lg text-center">
                                                            <span className="text-slate-400 text-sm font-medium">No tasks scheduled for this week</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            );
                ...
                >
                    <Button
                        ...
                        size="icon"
                        className="w-16 h-16 rounded-full bg-[#FDBA31] hover:bg-[#e5a82c] transition-colors text-slate-800 border-none shadow-xl flex items-center justify-center"
                    >
