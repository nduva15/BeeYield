            ...
            <div className="fixed inset-0 z-50 flex">
                ...
                <div className="relative w-72 max-w-[80vw] h-full bg-card border-r border-border flex flex-col shadow-lg animate-fade-in">
                    <div className="p-4 border-b border-border flex items-center justify-between">
                        ...
                        <button
                            onClick={onNew}
                            className="flex items-center gap-1.5 text-xs px-2.5 py-1.5 rounded-lg bg-primary text-primary-foreground hover:opacity-90 transition-all font-medium"
                        >
                    ...
                    <div className="flex-1 overflow-y-auto custom-scroll p-2 space-y-1">
                        ...
                        {filteredConversations.map((c) => (
                            <div
                                key={c.id}
                                className={`group flex items-center gap-2 px-3 py-2.5 rounded-lg cursor-pointer transition-all text-sm ${c.id === activeId
