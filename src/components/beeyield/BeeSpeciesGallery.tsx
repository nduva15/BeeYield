                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {selectedBee.traits.length > 0 ? selectedBee.traits.map((trait) => (
                                                ...
                                                <span className="text-[11px] font-semibold text-[#1A1A1A]/50">No diagnostic traits stored for this profile yet.</span>
                                            )}
                                        </div>
                                    </div>
                                </div>
            ...
            {filteredBees.length === 0 && (
                <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-[11px] font-semibold text-[#1A1A1A]/40 max-w-[220px] mx-auto">The requested taxonomy does not match the active live photo records.</p>
                    </div>
