...
const HpaOptimizer: React.FC = () => {
    ...
    return (
        <motion.div
            ...
            className={cn(glass.card, "p-0 overflow-hidden bg-white/80 dark:bg-[#0D0D0D]/80 backdrop-blur-3xl rounded-[6rem] border-white/5 relative shadow-4xl")}
        >
            <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-honey/[0.05] to-transparent pointer-events-none" />

            <div className="p-16 border-b border-white/5 bg-white/40 dark:bg-black/20 relative z-10">
            ...
            <div className="flex flex-col xl:flex-row relative z-10">
                {/* Inputs & Parameters */}
                <div className="w-full xl:w-[450px] p-16 space-y-16 bg-black/5 dark:bg-white/5 backdrop-blur-3xl border-r border-white/5 shrink-0">
                    <section className="space-y-10">
                        ...
                        <div className="space-y-10">
                            <div className="space-y-4">
                                ...
                                <div className="relative group">
                                    <input
                                        ...
                                        className={cn(glass.input, "h-20 px-10 text-3xl font-black italic border-white/10 group-hover:border-honey/40 transition-colors")}
                                    />
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex bg-black/20 p-2 rounded-[2.5rem] border border-white/5 gap-2 shadow-4xl">
                            ...
                            {['Almond', 'Cherry', 'Apple', 'Blueberry'].map((c) => (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        variety === c.toLowerCase() ? "bg-blue-400 border-blue-400 text-black shadow-4xl scale-[1.02]" : "border-white/10 text-foreground/40 hover:border-blue-400 hover:text-blue-400 hover:bg-blue-400/5"
                                    )}
                                >
                ...
                {/* Main Visualizer */}
                <div className="flex-1 p-16 lg:p-24 space-y-16 bg-white/5 dark:bg-black/5 min-h-[800px] relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 relative z-10">
                        ...
                        <div className={cn(glass.card, "aspect-square relative overflow-hidden group rounded-[5rem] border-white/10 shadow-4xl")}>
                            ...
                            <div className="absolute inset-0 p-12 flex flex-col justify-between z-10">
                                <div className="flex justify-between items-start">
                                    <div className={cn(glass.badge, 'bg-black/60 backdrop-blur-md border-white/10 px-6 py-2 rounded-full')}>
                                        <span className="text-[10px] font-black uppercase italic tracking-[0.4em]">Coverage Analysis</span>
                                    </div>
                                    <motion.div
                                        animate={{ scale: [1, 1.2, 1] }}
                                        transition={{ duration: 2, repeat: Infinity }}
                                        className="bg-red-500 text-white p-4 rounded-3xl border-4 border-black shadow-4xl"
                                    >
                                ...
                                <div className="space-y-4">
                                    <div className="p-6 rounded-3xl bg-black/60 backdrop-blur-xl border border-white/10 shadow-4xl flex items-center gap-6">
                                        <div className="w-4 h-4 rounded-full bg-red-500 shadow-[0_0_15px_rgba(239,68,68,0.8)]" />
                                        <p className="text-[14px] font-black text-white uppercase italic tracking-widest leading-tight">
                            ...
                            <div className={cn(glass.card, "p-12 bg-honey text-black shadow-4xl rounded-[5rem] group relative overflow-hidden transition-all hover:scale-[1.02]")}>
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-xl font-black italic uppercase leading-relaxed max-w-sm pl-4 border-l-8 border-black/20">
                                        We recommend placing <span className="text-white">12 hives per pallet</span> to cover your {acreage} acres perfectly.
                                    </p>
                                </div>
                            </div>

                            <div className="space-y-8">
                                <div className="flex items-center gap-8 p-10 rounded-[3.5rem] bg-white/40 dark:bg-black/40 border border-white/10 shadow-4xl group/stat hover:bg-honey/5 transition-all">
                                ...
                                <div className="flex items-center gap-8 p-10 rounded-[3.5rem] bg-white/40 dark:bg-black/40 border border-white/10 shadow-4xl group/stat hover:bg-emerald-500/5 transition-all">
                    ...
                    <div className="p-16 rounded-[5rem] bg-white/40 dark:bg-black/40 border border-white/10 backdrop-blur-3xl flex items-center gap-12 shadow-4xl relative z-10 hover:border-honey/20 transition-all group/info">
