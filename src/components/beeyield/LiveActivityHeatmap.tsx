...
const LiveActivityHeatmap: React.FC<LiveActivityHeatmapProps> = ({ onTabChange }) => {
    ...
    return (
        <div className="p-8 space-y-12 bg-[#FFF9F0] min-h-screen text-[#064e3b] antialiased relative overflow-hidden">
            {/* Header */}
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b-4 border-[#064e3b] pb-8 relative z-10">
                ...
                <div className="flex items-center gap-4">
                    <div className="flex bg-[#064e3b] p-1 border-4 border-[#064e3b] shadow-[4px_4px_0px_0px_#10b981]">
                        <div className="px-4 py-2 bg-[#FFF9F0] flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 relative z-10">
                    ...
                    <div className="border-8 border-[#064e3b] bg-[#064e3b]/5 h-[600px] relative overflow-hidden shadow-[20px_20px_0px_px_rgba(6,78,59,0.05)]">
                        ...
                        <div className="absolute inset-0 grid grid-cols-6 grid-rows-4 p-4 gap-2">
                            {sectors.map((s) => (
                                ...
                                >
                                    {activeSector === s.id && (
                                        <div className="bg-[#064e3b] text-[#1A1A1A] p-2 border-2 border-white pointer-events-none transform -translate-y-8 animate-in fade-in slide-in-from-bottom-2">
                        ...
                        <div className="absolute bottom-6 left-6 backdrop-blur-md bg-[#F4D03F]/10 border-4 border-[#064e3b] p-6 shadow-2xl max-w-xs">
                            ...
                            <button className="w-full mt-6 py-3 border-4 border-[#064e3b] text-[9px] font-black uppercase tracking-widest hover:bg-[#064e3b] hover:text-[#1A1A1A] transition-none">
                ...
                <div className="lg:col-span-4 space-y-10">
                    <div className="border-4 border-[#064e3b] p-8 bg-[#FFF9F0] shadow-[10px_10px_0px_0px_#10b981]">
                    ...
                    {/* VPM Summary */}
                    <div className="border-4 border-[#064e3b] p-8 bg-[#064e3b] text-[#1A1A1A] shadow-[10px_10px_0px_0px_#facc15]">
                        ...
                        <div className="space-y-6">
                            <div>
                                <div className="flex justify-between items-baseline mb-2">
                                    ...
                                    <p className="text-[10px] font-black uppercase text-gray-700">Avg VPM</p>
                                </div>
                                <div className="h-4 w-full bg-[#F4D03F]/10 relative">
