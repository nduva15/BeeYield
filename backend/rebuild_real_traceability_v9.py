...
def seed():
    try:
        ...
        try:
            ...
            print(f"[ERROR] Farmer insert failed: {e}")
            sys.exit(1)
        ...
        try:
            ...
            print(f"[ERROR] Apiary insert failed: {e}")
            sys.exit(1)
        ...
        for i in range(1, 185):
            ...
            if i % 50 == 0:
                ...
                try:
                    ...
                    print(f"[ERROR] Hives insert failed at {i}: {e}")
                    sys.exit(1)
        ...
        for i in range(1, 16):
            ...
            try:
                ...
                print(f"[ERROR] Harvest insert failed: {e}")
                sys.exit(1)
            ...
            try:
                ...
                print(f"[ERROR] Processing insert failed: {e}")
                sys.exit(1)
            ...
            try:
                ...
                print(f"[ERROR] Batches insert failed: {e}")
                sys.exit(1)
            ...
            try:
                ...
                print(f"[ERROR] HoneyBatches insert failed: {e}")
