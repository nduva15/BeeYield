...
class TraceabilityService:
    ...
    async def _build_trace_response(view: dict[str, Any], token: Optional[str] = None) -> schemas.TraceResponse:
        ...
        return schemas.TraceResponse(
            ...
            quantity_left_for_bees_kg=harvest.get("quantity_left_for_bees_kg"),
            extraction_method=harvest.get("extraction_method"),
            nectar_source=harvest.get("nectar_source"),
            weather_conditions=harvest.get("weather_conditions"),
            moisture_content_percent=harvest.get("moisture_content_percent"),
