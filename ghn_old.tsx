                ...
                <Card className="bg-background/10 border-background/20 backdrop-blur-sm overflow-hidden">
                  <CardContent className="p-8">
                    ...
                    <p className="text-background/80 leading-relaxed mb-6">
                      A major indication of the health of a hive is the density of bees on its frames. But with growing bee mortality rates, it is becoming increasingly frequent for beekeepers around the world to open their hives ΓÇô and discover weak hives with few, if any, bees.
                    </p>
            ...
            <div className="space-y-16 max-w-6xl mx-auto">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-6">
                    Partnering with the Israeli Honey Board, BeeYield is spearheading a ground-breaking study on optimal hive density for the Hass avocado cultivar. Little is known about the density that maximizes fruit set without harming colony healthΓÇöuntil now.
                  </p>
