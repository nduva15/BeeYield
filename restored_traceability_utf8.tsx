        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <p className="mb-8 text-xl leading-relaxed text-muted-foreground">
              ...
              The other half? It stays exactly where it belongsΓÇöwith the bees who made it.
            </p>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mb-12 rounded-2xl bg-background p-8 shadow-soft">
              ...
              <p className="text-lg leading-relaxed text-muted-foreground">
                Our revolutionary traceability system lets you trace every jar back to its sourceΓÇönot just the country 
      ...
      <div className="bg-primary/5 py-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <p className="mb-8 text-xl leading-relaxed text-muted-foreground">
              Every jar of BeeYield honey carries more than just sweetnessΓÇöit carries a story of ethical beekeeping, 
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <div className="rounded-full bg-background px-6 py-3 shadow-soft">
                <span className="font-medium">≡ƒÉ¥ Bee-First Philosophy</span>
              </div>
              <div className="rounded-full bg-background px-6 py-3 shadow-soft">
                <span className="font-medium">≡ƒî╕ Single-Origin Purity</span>
              </div>
              <div className="rounded-full bg-background px-6 py-3 shadow-soft">
                <span className="font-medium">≡ƒöì Complete Transparency</span>
              </div>
            </div>
          </div>
        </div>
