        ...
        <div className="min-h-screen bg-background">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="text-white space-y-8">
                            ...
                            <p className="text-xl text-white/90 max-w-lg leading-relaxed font-medium">
                                ...
                                a promise ΓÇö every flower visited, every yield maximized, every harvest transformed.
                            </p>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center space-y-10">
                        ...
                        <p className="text-xl text-muted-foreground leading-relaxed">
                            ...
                            This isn't just pollination ΓÇö it's <span className="text-primary font-black">precision agriculture</span> at its finest.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-32 relative overflow-hidden bg-amber-900 text-white rounded-[5rem] mx-4 mb-8">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center space-y-12">
                    ...
                    <p className="text-white/40 text-xs font-black uppercase tracking-widest">Global Support ΓÇó Real-time Data ΓÇó Guaranteed Impact</p>
                </div>
            </section>
        </div>
    );
